...
def main():
    with tempfile.TemporaryDirectory() as directory:
        ...
        for name in ("triage-issue-v1.schema.json", "triage-pr-v1.schema.json", "deep-review-text-v1.schema.json", "nl-decision-v1.schema.json", "advisory-review-v2.schema.json"):
