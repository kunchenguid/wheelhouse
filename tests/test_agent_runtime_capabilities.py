...
def main():
    ...
    check("investigation: GLM OpenCode remains unapproved and untargeted", runtime["investigations"] == {"glm-opencode": "unapproved"} and all(row["target"] == "claude" for row in runtime["actions"].values()))
