...
> The machine value `INELIGIBLE` remains unchanged in persisted state, but its card presentation is **MANUAL REVIEW REQUIRED**. Existing/default behavior changes do not qualify for automatic-merge class A, B, or C.
